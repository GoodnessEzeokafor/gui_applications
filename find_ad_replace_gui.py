...
Entry(parent, width=50).grid(row=0, column=1, padx=2, pady=2, sticky=E, columnspan=9)

Label(parent, text="Replace").grid(row=1, column=0, sticky=E)
Entry(parent, width=50).grid(row=1, column=1, padx=2, pady=2, sticky="we", columnspan=9)


Button(parent, text="Find").grid(
    row=0, column=10, stick='e'+'w', padx=2
)
Button(parent, text="FInd All").grid(
    row=1, 
    column=10, sticky='e' + 'w', padx=2
)
Button(parent, text="Replace").grid(
    row=2,
    column=10, sticky='e' + 'w',
    padx=2
)
...
Radiobutton(parent,text='Down').grid(
    row=3,
    column=7,
    columnspan=2,
    sticky='e'
